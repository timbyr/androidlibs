...
public abstract class AbstractDatabaseHelper extends SQLiteOpenHelper {
	 ...
	 * @param context
	 */
	public AbstractDatabaseHelper(Context context, String DB_NAME,
	...
	private SQLiteDatabase getDataBase(boolean writable) throws SQLException {
		if (mDatabase != null) {
			if (!mDatabase.isOpen()) {
		...
		if (mDatabase == null)
		{
			...
			mDatabase = SQLiteDatabase.openDatabase(myPath.getAbsolutePath(), mFactory, flags);
		}
		return mDatabase;
	}
